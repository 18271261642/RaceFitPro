...
public class WaveProgress extends View {
    ...
    private void initPaint(Context context) {
        ...
        setTagPaint.setTextSize(MiscUtil.dipToPx(context,15));
...
//                + ";圆的外接矩形 = " + mRectF.toString());
    ...
    private void drawProgress(Canvas canvas) {
       // Log.e(TAG,"-----drawProgress--");
        ...
        canvas.drawText(getResources().getString(R.string.steps),
                mCenterPoint.x+(MiscUtil.getTextWidth(mPercentPaint,decimalFormat.format(mValue)))/2+MiscUtil.dipToPx(getContext(),20), y, mHintPaint);
