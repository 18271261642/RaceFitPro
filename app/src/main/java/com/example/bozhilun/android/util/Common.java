...
public class Common {
    ...
    public static void showShare(Context context, String platformToShare, boolean showContentEdit, String uil) {
        ...
        oks.setComment(context.getResources().getString(R.string.ssdk_weibo_upload_content)); //我对这条分享的评论，仅在人人网和QQ空间使用，否则可以不提供
        oks.setSite("RaceFitPro");  //QZone分享完之后返回应用时提示框上显示的名称
        //oks.setTitle("RaceFitPro");
        //oks.setTitleUrl("http://sharesdk.cn");
        //oks.setUrl("https://sj.qq.com/myapp/detail.htm?apkName=com.example.bozhilun.android");
...
//       // oks.setTitleUrl("https://sj.qq.com/myapp/detail.htm?apkName=com.example.bozhilun.android");
//        // text是分享文本，所有平台都需要这个字段
//        //oks.setText("我是分享文本");
//        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
//        oks.setImagePath(uil);//确保SDcard下面存在此张图片
