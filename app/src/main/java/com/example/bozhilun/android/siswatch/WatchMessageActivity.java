...
public class WatchMessageActivity extends WatchBaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    @OnClick({R.id.watch_message_jiangeLin, R.id.watch_msgOpenNitBtn,
            R.id.watch_msgOpenAccessBtn, R.id.watchMsgExplainTv,
            R.id.newSearchRightImg1,R.id.newShearchImg})
