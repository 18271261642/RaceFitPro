    ...
    private void whichDevice() {
        ...
        switch (is18i) {
            ...
            case "W30S":
                ...
                //获取目标步数
                String w30stag = (String) SharedPreferencesUtils.getParam(this, "w30stag", "10000");
                //获取目标睡眠
                TSTEP = Integer.valueOf(w30stag.trim());
                String w30ssleep = (String) SharedPreferencesUtils.getParam(this, "w30ssleep", "8");
    ...
    public void onclick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ischange_ok:
                ...
                String step = (String) SharedPreferencesUtils.getParam(B18ITargetSettingActivity.this, "StepNumber", "10000");
                ...
                if (is18i.equals("W30S")) {
                    ...
                    String setSteps = stepNumbers.getText().toString().trim();
                    if(WatchUtils.isEmpty(setSteps))
                        setSteps = "10000";
                    setW30GoalStep(Integer.valueOf(setSteps));
...
//                                //目标步数
//                                SharedPreferencesUtils.setParam(this, "w30stag", step);
//                                MyApp.getInstance().getmW30SBLEManage().setTargetStep(Integer.valueOf(step));
//                            }
//                        }
//                        if (!String.valueOf(TSLEEP).equals(sleep)) {
//                            if (!WatchUtils.isEmpty(sleep)) {
//                                //目标睡眠
//                                SharedPreferencesUtils.setParam(this, "w30ssleep", sleep);
//                            }
//                        }
//                        finish();
//                    }
...
//                    SharedPreferencesUtils.setParam(B18ITargetSettingActivity.this, "distanionData", "");
    ...
    //设置W30或W31的目标步数
    private void setW30GoalStep(int goStep){
        Log.e(TAG,"-------setp="+goStep);
        //MyApp.getInstance().getmW30SBLEManage().setTargetStep(goStep);
        W37DataAnalysis.getW37DataAnalysis().setW37GoalStep(goStep);
    ...
    private void setSleepTime() {
        ...
        if (is18i.equals("W30S")) {
            //获取目标步数
            mSleep = (String) SharedPreferencesUtils.getParam(this, "w30ssleep", "8");
        } else {
        ...
        ProfessionPick sleepingtime = new ProfessionPick.Builder(B18ITargetSettingActivity.this, new ProfessionPick.OnProCityPickedListener() {
            ...
            public void onProCityPickCompleted(String profession) {
                ...
                SharedPreferencesUtils.setParam(B18ITargetSettingActivity.this, "w30ssleep", profession);
    ...
    private void setStepNumber() {
        ...
        if (is18i.equals("W30S")) {
            //获取目标步数
            mStep = (String) SharedPreferencesUtils.getParam(this, "w30stag", "10000");
        } else {
        ...
        ProfessionPick stepsnumber = new ProfessionPick.Builder(B18ITargetSettingActivity.this, new ProfessionPick.OnProCityPickedListener() {
            ...
            public void onProCityPickCompleted(String profession) {
                ...
                SharedPreferencesUtils.setParam(B18ITargetSettingActivity.this, "w30stag", profession);
