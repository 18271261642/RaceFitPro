...
public class BatteryView extends View {
    ...
    private void initPaint() {
        powerTxtPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        powerTxtPaint.setStyle(Paint.Style.FILL);
        powerTxtPaint.setTextSize(DimenUtil.dp2px(getContext(),12f));
        powerTxtPaint.setColor(Color.WHITE);
    ...
    private void drawHorizontalBattery(Canvas canvas) {
        ...
        canvas.drawText(mPower+"",(width/2)-(DimenUtil.getTextWidth(powerTxtPaint,mPower+"")/2),height/2+MiscUtil.measureTextHeight(powerTxtPaint)/2,powerTxtPaint);
