...
import com.example.bozhilun.android.w30s.activity.ShockDetailedActivity;
...
public class B15PMoreShockActivity extends WatchBaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private void getSharedP() {
        boolean w30sSedentaryRemind = (boolean) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "w30sSedentaryRemind", false);
        boolean w30sDringRemind = (boolean) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "w30sDringRemind", false);
        boolean w30sMedicineRemind = (boolean) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "w30sMedicineRemind", false);
        boolean w30sMedicineRemind1 = (boolean) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "w30sMettingRemind", false);
            ...
            if (requestCode == 1) {
                switch (resultCode) {
                    case 1:
                        ...
                        //久坐
                        SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sSedentaryRemind", true);
                    ...
                    case 2:
                        ...
                        //喝水
                        SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sDringRemind", true);
                    ...
                    case 3:
                        ...
                        MyApp.getInstance().getmW30SBLEManage().setMedicalNotification(Integer.valueOf(startimeM[0]),
                                Integer.valueOf(startimeM[1]), Integer.valueOf(endtimeM[0]),
                                Integer.valueOf(endtimeM[1]),
                                Integer.valueOf(substringM), true);
                        //吃药
                        SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sMedicineRemind", true);
                    ...
                    case 4:
                        ...
                        MyApp.getInstance().getmW30SBLEManage().setMeetingNotification(yearM,
                                motohM, dayM, hourM, minM, true);
                        //会议
                        SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sMettingRemind", true);
    ...
    public void onViewClicked(View view) {
        Intent intent = new Intent(B15PMoreShockActivity.this, ShockDetailedActivity.class);
        switch (view.getId()) {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case R.id.sw_sedentary_remind:
                ...
                String intervalTime_sedentary = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "IntervalTime_sedentary", "1H");
                String starTime_sedentary = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "starTime_sedentary", "06:00");
                String endTime_sedentary = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "endTime_sedentary", "22:00");
                ...
                SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sSedentaryRemind", isChecked);

                Log.e("=========", "久坐提醒设置  -- " +
                        "\n开始时间： " + splitSs[0] + "时" + splitSs[1] + "分 -- " + splitEs[0] + "时" + splitEs[1] + "分 -- 间隔：" + substring2 + "时  " + (isChecked ? "打开" : "关闭"));
            ...
            case R.id.sw_dring_remind:
                 ...
                 * @return
                 */
                String intervalTime_dring = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "IntervalTime_dring", "1H");
                String starTime_dring = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "starTime_dring", "06:00");
                String endTime_dring = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "endTime_dring", "22:00");
                ...
                SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sDringRemind", isChecked);

                Log.e("=========", "喝水提醒设置  -- " +
                        "\n开始时间： " + splitSd[0] + "时" + splitSd[1] + "分 -- " + splitEd[0] + "时" + splitEd[1] + "分 -- 间隔：" + substring1 + "时  " + (isChecked ? "打开" : "关闭"));
            ...
            case R.id.sw_medicine_remind:
                 ...
                 * @return
                 */
                String intervalTime_medicine = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "IntervalTime_medicine", "4H");
                String starTime_medicine = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "starTime_medicine", "06:00");
                String endTime_medicine = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "endTime_medicine", "22:00");
                ...
                SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sMedicineRemind", isChecked);

                Log.e("=========", "吃药提醒设置  -- " +
                        "\n开始时间： " + splitSm[0] + "时" + splitSm[1] + "分 -- " + splitEm[0] + "时" + splitEm[1] + "分 -- 间隔：" + substring + "时  " + (isChecked ? "打开" : "关闭"));
            ...
            case R.id.sw_metting_remind:
                ...
                String datas = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "IntervalTime_metting_data", dateStr2);
                String times = (String) SharedPreferencesUtils.getParam(B15PMoreShockActivity.this, "IntervalTime_metting_time", W30BasicUtils.getCurrentDate3().substring(0, W30BasicUtils.getCurrentDate3().length() - 3));
...
//                Log.d("-会议设置-time--", time[0] + "=" + time[1]);
                ...
                int minM = (int) Integer.valueOf(time[1]);
                Log.e("=========", "会议提醒设置  -- " +
                        "\n开始时间： " + yearM + "年" + motohM + "月" + dayM + "日 " + hourM + "时" + minM+"分   " + (isChecked ? "打开" : "关闭"));
                SharedPreferencesUtils.setParam(B15PMoreShockActivity.this, "w30sMettingRemind", isChecked);
                MyApp.getInstance().getmW30SBLEManage().setMeetingNotification(yearM, motohM, dayM, hourM, minM, isChecked);
                break;
        }
    }
}
