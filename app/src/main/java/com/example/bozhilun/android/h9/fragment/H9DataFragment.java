...
//            jsonObect.put("deviceCode", SharedPreferencesUtils.readObject(getActivity(), Commont.BLEMAC));
...
//        commonSubscriber = new CommonSubscriber(subscriberOnNextListener, MyApp.getInstance());
...
//        map.put("deviceCode", (String) SharedPreferencesUtils.readObject(getActivity(), Commont.BLEMAC));
...
//        axisX.hasLines();
//        //x轴颜色
//        axisX.setTextColor(getResources().getColor(R.color.new_colorAccent));
