        ...
        public void onCheckedChanged(CompoundButton buttonView, final boolean isChecked) {
            ...
            switch (buttonView.getId()) {
                case R.id.switch_Lose:
                    ...
                    SharedPreferencesUtils.saveObject(MyApp.getContext(), "ANTI_LOST", isChecked);
                    break;
                case R.id.switch_phone:
                    ...
                    SharedPreferencesUtils.saveObject(MyApp.getContext(), "INCOME_CALL", isChecked);
                    break;
...
//                            }).start();
                ...
                case R.id.switch_messge:
                    ...
                    SharedPreferencesUtils.saveObject(MyApp.getContext(), "SMS", isChecked);
                    break;
                case R.id.switch_email:
                    ...
                    SharedPreferencesUtils.saveObject(MyApp.getContext(), "MAIL", isChecked);
                    break;
...
//                                .sendCommand(new SwitchSetting(commandResultCallback, 3, (byte) 1, (byte) 15, myByte));//SKYPE开关
                    ...
                    SharedPreferencesUtils.saveObject(MyApp.getContext(), "SOCIAL", isChecked);
                    break;
