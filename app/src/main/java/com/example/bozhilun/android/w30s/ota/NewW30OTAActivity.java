 ...
 * Date 2019/5/21
 */
public class NewW30OTAActivity extends WatchBaseActivity implements RequestView {
    private static final String TAG = "NewW30OTAActivity";
    public static final String UpData = "com.exalpme.bozhilun.android.w30s.ota";
    //下载升级包的保存路径，完整的路径，不能是文件夹的路径
    private String downLoadSaveUrl = "/storage/emulated/0/Android/data/com.example.bozhilun.android/cache/W30/W30V3.zip";
            ...
            switch (msg.what){
                case 1001:      //扫描到设备了
                    ...
                    if("DfuTarg".equals(bdevice.getName().trim())){
                        ...
                        SharedPreferencesUtils.setParam(NewW30OTAActivity.this, "UPM", bdevice.getAddress());
...
//                        }
                        ...
                        if(MyApp.getInstance().getW37ConnStatusService() != null){
                            progressNumberTv.setText(getResources().getString(R.string.auto_upgrade));
                            MyApp.getInstance().getW37ConnStatusService().connW37ByMac(bleBac,"W30");
                        }
                ...
                case 1002:  //连接成功，开始校验升级文件
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            starter.start(NewW30OTAActivity.this, W30SDfuService.class);//开始升级
                        }
                    });
   ...
   //升级的监听
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(W37Constance.W37_DISCONNECTED_ACTION)){    //断开连接
                ...
                if(isOtaSuccess){
                    String saveMac = WatchUtils.getSherpBleMac(NewW30OTAActivity.this);
                   // MyApp.getInstance().getmW30SBLEManage().getmW30SBLEServices().connectBle("W30",saveMac);

                    MyApp.getInstance().getW37ConnStatusService().connW37ByMac(saveMac,"W30");
    ...
    private void getDeviceVersion(){
        if(requestPressent != null){
            String w30S_v = (String) SharedPreferencesUtils.getParam(NewW30OTAActivity.this, "W30S_V", "20");
            ...
            if (requestPressent != null) {
                //获取版本
                requestPressent.getRequestJSONObject(0x01, baseUrl + URLs.getVersion, NewW30OTAActivity.this, new Gson().toJson(jsonObect), 0);
            }
        }
    }
