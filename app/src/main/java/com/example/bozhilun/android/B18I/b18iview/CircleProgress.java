...
//        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, Constant.DEFAULT_ANIM_TIME);
        ...
        mHint = typedArray.getString(R.styleable.CircleProgressBar_hint);
        mHintColor = typedArray.getColor(R.styleable.CircleProgressBar_hintColor, Color.BLACK);
        mHintSize = typedArray.getDimension(R.styleable.CircleProgressBar_hintSize, MyApp.getContext().getResources().getDimension(R.dimen.size_15));
        ...
        mValueColor = typedArray.getColor(R.styleable.CircleProgressBar_valueColor, Color.BLACK);
//        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, Constant.DEFAULT_VALUE_SIZE);
        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, MyApp.getContext().getResources().getDimension(R.dimen.size_30));

        mUnit = typedArray.getString(R.styleable.CircleProgressBar_unit);
        mUnitColor = typedArray.getColor(R.styleable.CircleProgressBar_unitColor, Color.BLACK);
        mUnitSize = typedArray.getDimension(R.styleable.CircleProgressBar_unitSize, MyApp.getContext().getResources().getDimension(R.dimen.size_30));

        mArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_arcWidth, MyApp.getContext().getResources().getDimension(R.dimen.size_6));
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgressBar_startAngle, Constant.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle, Constant.DEFAULT_SWEEP_ANGLE);

        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, Color.parseColor("#70FFFFFF"));//"#43FFFFFF"));
        mBgArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgArcWidth, MyApp.getContext().getResources().getDimension(R.dimen.size_6));
        mTextOffsetPercentInRadius = typedArray.getFloat(R.styleable.CircleProgressBar_textOffsetPercentInRadius, 0.33f);
...
//        mPoints.setStrokeWidth(mBgArcWidth);
        ...
        mTextp.setTextSize(MyApp.getContext().getResources().getDimension(R.dimen.size_15));
...
//        mTextp.setStrokeWidth(1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(MiscUtil.measure(widthMeasureSpec, (int) mDefaultSize),
                MiscUtil.measure(heightMeasureSpec, (int) mDefaultSize));
    }
...
//        }
        double x1 = (mCenterPoint.x + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_2)) * Math.cos(currentAngle * Math.PI / 180));
        double y1 = (mCenterPoint.y + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_2)) * Math.sin(currentAngle * Math.PI / 180));
        myPoints.setColor(Color.parseColor("#85ffffff"));
        myPoints.setStrokeWidth(MyApp.getContext().getResources().getDimension(R.dimen.size_15));
        canvas.drawPoint((float) x1, (float) y1, myPoints);

        double x = (mCenterPoint.x + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_2)) * Math.cos(currentAngle * Math.PI / 180));
        double y = (mCenterPoint.y + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_2)) * Math.sin(currentAngle * Math.PI / 180));
        myPoints.setColor(Color.parseColor("#FFFFFF"));
        myPoints.setStrokeWidth(MyApp.getContext().getResources().getDimension(R.dimen.size_10));
...
//        canvas.drawPoint(mRectF.height()/2+mBgArcWidth/2,mBgArcWidth/2,mPoints);
        ...
        for (int i = 0; i <= 10; i++) {
            double x = (mCenterPoint.x + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_3)) * Math.cos(i * 36 * Math.PI / 180));
            double y = (mCenterPoint.y + (mRadius + MyApp.getContext().getResources().getDimension(R.dimen.size_3)) * Math.sin(i * 36 * Math.PI / 180));
            mPoints.setColor(Color.parseColor("#FFFFFF"));
            mPoints.setStrokeWidth(mBgArcWidth);
//            Log.e(TAG, x + "===" + y);
