...
public class UploadStepsModel {
    ...
    public void modelUpdateStr(Context mContext,String url, String jsonStr,SubscriberOnNextListener<String> subscriberOnNextListener){
        CommonSubscriber commonSubscriber = new CommonSubscriber(subscriberOnNextListener, mContext);
        OkHttpObservable.getInstance().getData(commonSubscriber,url,jsonStr);
    }
