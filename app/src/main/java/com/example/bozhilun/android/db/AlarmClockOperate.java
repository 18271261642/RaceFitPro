...
public class AlarmClockOperate {
    ...
    public void updateAlarmClock(AlarmClock alarmClock) {
        if (alarmClock != null) {
            ...
            LitePal.update(AlarmClock.class, cv, alarmClock.getId());
        }
    }
    ...
    public void updateAlarmClock(boolean onOff, Long id) {
        ...
        LitePal.update(AlarmClock.class, cv, id);
    }

    public List<AlarmClock> loadAlarmClocks() {
        List<AlarmClock> alarmClockList;
        alarmClockList = LitePal.order("hour,minute asc").find(AlarmClock.class);
