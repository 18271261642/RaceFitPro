 ...
 * Date 2019/5/21
 */
public class NewW31OTAActivity extends WatchBaseActivity implements RequestView {
    ...
    private String downLoadSaveUrl = "/storage/emulated/0/Android/data/com.example.bozhilun.android/cache/W31/W31V3.zip";
            ...
            switch (msg.what) {
                case 1001:      //扫描到设备了
                    ...
                    if ("DfuTarg".equals(bdevice.getName().trim())) {
                        ...
                        SharedPreferencesUtils.setParam(NewW31OTAActivity.this, "UPM", bdevice.getAddress());
...
//                        }
                        ...
                        if (MyApp.getInstance().getW37ConnStatusService() != null) {
                            progressNumberTv.setText(getResources().getString(R.string.auto_upgrade));
                            MyApp.getInstance().getW37ConnStatusService().connW37ByMac(bleBac, "W31");
                        }
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            DfuServiceInitiator starter = new DfuServiceInitiator(deviceAddress)//设备地址
                                    .setDeviceName("W31")//设备名
                                    .setDisableNotification(true)
                                    .setKeepBond(true);
                            starter.setZip(downLoadSaveUrl);
                            starter.start(NewW31OTAActivity.this, W30SDfuService.class);//开始升级
                        }
                    });
...
//                    W30SBLEManage.mW30SBLEServices.disClearData();
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(W37Constance.W37_DISCONNECTED_ACTION)) {    //断开连接
                ...
                if (isOtaSuccess) {
                    String saveMac = WatchUtils.getSherpBleMac(NewW31OTAActivity.this);
                    // MyApp.getInstance().getmW30SBLEManage().getmW30SBLEServices().connectBle("W30",saveMac);

                    MyApp.getInstance().getW37ConnStatusService().connW37ByMac(saveMac, "W31");
        ...
        try {
            ...
            if (jsonObject.getInt("code") == 200) {
                ...
                if (dataJsono != null) {
                    ...
                    String deviceVersion = (String) SharedPreferencesUtils.getParam(NewW31OTAActivity.this, "W31S_V", "20");
    ...
    private void downloadUpdatePack(String douwnlUrl) {
        Aria.download(this)
                .load(String.valueOf(douwnlUrl))     //读取下载地址
    ...
    private void getDeviceVersion() {
        if (requestPressent != null) {
            String w30S_v = (String) SharedPreferencesUtils.getParam(NewW31OTAActivity.this, "W31S_V", "20");
            if (WatchUtils.isEmpty(w30S_v))
                return;
            String baseUrl = Commont.FRIEND_BASE_URL;
            Map<String, String> jsonObect = new HashMap<>();
            jsonObect.put("clientType", "Android_W31");
            jsonObect.put("version", w30S_v);
            if (requestPressent != null) {
                //获取版本
                requestPressent.getRequestJSONObject(0x01, baseUrl + URLs.getVersion, NewW31OTAActivity.this, new Gson().toJson(jsonObect), 0);
            }
        }
    }
