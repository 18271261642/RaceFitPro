 ...
 * 室外骑行
 */
public class OutdoorCyclingActivityStar extends BaseActivity{
    @Override
    ...
    protected int getContentViewId() {
        return 0;
    }// implements LocationSource, com.amap.api.location.AMapLocationListener, AMap.OnMarkerClickListener, AMap.OnMapClickListener, OnMapReadyCallback {
...
//    TextView gonglidanwei;
//    @BindView(R.id.full_kilometer_ziti)
//    TextView full_kilometer_zitidanwei;
//
//    /*** 年月日加时间*/
...
//        /**查询当前的运动类型*/
//        try {
//            if (!TextUtils.isEmpty((String) SharedPreferencesUtils.readObject(OutdoorCyclingActivityStar.this, "type"))) {
...
//
//        //判断是否为公职
//        paramDan = (boolean) SharedPreferencesUtils.getParam(OutdoorCyclingActivityStar.this, Commont.ISSystem, true);
//        if (paramDan) {
//            gonglidanwei.setText("KM");
//            full_kilometer_zitidanwei.setText(getResources().getString(R.string.distance));
//        } else {
//            gonglidanwei.setText("mile");
//            full_kilometer_zitidanwei.setText(getResources().getString(R.string.distance_ying));
//        }
//    }
//
//
...
////                        .findFragmentById(R.id.qixinggoogle_map);
////                mapFragment.getMapAsync(OutdoorCyclingActivityStar.this);
//
//                mapFragment.getMapAsync(OutdoorCyclingActivityStar.this);//Google地图初始化
//            }
...
//                    try {
//
//                        //if (Mymap!=null&&Mymap.get(Mymap.size()-1))
////                        com.alibaba.fastjson.JSONObject jsonObject = (com.alibaba.fastjson.JSONObject) Mymap.get(Mymap.size() - 1);
//////                        if (jsonObject.has("lat")&&jsonObject.has("lon")) {
////                        MyLogUtil.d("-----地图----", jsonObject.getLong("lat") + "---" + jsonObject.getLong("lon") + "");
//
//                        com.alibaba.fastjson.JSONObject beanList = new com.alibaba.fastjson.JSONObject();
...
//                promptDialog.setContent(getResources().getString(R.string.string_out_gps));
...
//                    try {
//                        //路程
//                        String discanceStr = gongli.getText().toString().trim();
//                        //速度
//                        String speedStr = speed.getText().toString().trim();
//                        //取得配速
//                        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
//                        Mgps.put("rtc", df.format(new Date()));
//                        Mgps.put("speed", speedStr.equals("00'00") ? "0.0" : Double.valueOf(speed.getText().toString()));
//                        //取得公里
//                        Mgps.put("distance", discanceStr.equals("00'00") ? "0.0" : Double.valueOf(Double.parseDouble(gongli.getText().toString())));
...
//            ToastUtil.showToast(OutdoorCyclingActivityStar.this, getResources().getString(R.string.string_not_net));
//        } else {
//            try {
//                HashMap<String, Object> map = new HashMap<>();
//                Mgps.put("userId", SharedPreferencesUtils.readObject(OutdoorCyclingActivityStar.this, "userId"));
